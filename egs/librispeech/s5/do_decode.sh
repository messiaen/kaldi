...
#datadir=/export/b05/gclar/kaldi/egs/fisher_english/s5/data/train_all
datadir=/export/b05/gclar/kaldi/egs/fisher_english/s5/data/train_all/split300/1
...
steps/online/nnet2/decode.sh --cmd "$decode_cmd" --nj 60 \
  $graphdir $datadir $modeldir/decode_fisher_english_train_all || exit 1;
